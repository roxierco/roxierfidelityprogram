      ...
      <div className="w-full max-w-sm space-y-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 rounded-2xl px-4 py-3 shadow-lg active:scale-95 transition-transform"
          ...
          <button
            onClick={copyLink}
            className="flex items-center justify-center gap-2 rounded-2xl px-4 py-3 shadow-lg active:scale-95 transition-transform"
