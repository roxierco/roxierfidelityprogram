      ...
      <section className="relative mx-auto max-w-6xl px-6 pt-20 pb-28 text-center">
        ...
        <div className="relative z-10">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/50 leading-relaxed">
            Crea tarjetas de lealtad digitales en minutos. Tus clientes las guardan en Apple Wallet y Google Wallet
      ...
      <section id="como-funciona" className="mx-auto max-w-6xl px-6 py-28">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            { num: "02", icon: "M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8H2a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 00-2-2h-1m-3-6V4a2 2 0 00-2-2H6a2 2 0 00-2 2v10", title: "Tus clientes escanean", text: "El cliente escanea el QR en tu negocio y su tarjeta queda guardada en Apple Wallet o Google Wallet al instante." },
      ...
      <section id="caracteristicas" className="relative py-28 overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-6 relative z-10">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { icon: "M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z", title: "Apple Wallet y Google Wallet", text: "Tus clientes guardan su tarjeta directamente en Apple Wallet o Google Wallet con un toque." },
