      ...
      <div className="w-full max-w-md">
        ...
        <div className="card">
          ...
          <p className="mb-6 text-sm text-mist">
            <strong className="text-green-400">7 días gratis, sin tarjeta.</strong> Después <span className="text-mist line-through">$749</span> <strong className="text-paper">$547 MXN/mes</strong> — precio de lanzamiento. Sin cuota de activación.
          </p>
